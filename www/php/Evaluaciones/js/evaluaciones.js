...
function highlight(div_id, style) {
	highlightRow(div_id, style == "error2" ? "#e5afaf" : style == "warning" ? "#ffcc00" : "#8dc70a");
}
...
{      
//alert(editableGrid.getRowId(rowIndex));
//alert(this.grid.id);
//alert(rowIndex);
	$.ajax({
		url: 'update.php',
...
{ 
	this.editableGrid = new EditableGrid("evaluaciones_planificacion", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("loaddata.php?db_tablename=evaluaciones_planificacion");
};
