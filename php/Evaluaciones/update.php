...
echo "<script type='text/javascript'>alert('$colname');</script>";
echo "<script type='text/javascript'>alert('$id');</script>";
echo "<script type='text/javascript'>alert('$coltype');</script>";
...
//$consulta = "UPDATE ".$tablename." SET ".$colname." = ".$value." WHERE id =".$id;
/*echo "<script type='text/javascript'>alert('$consulta');</script>";*/

// This very generic. So this script can be used to update several tables.
$return=false;
if ( $stmt = $mysqli->prepare("UPDATE ".$tablename." SET ".$colname." = ? WHERE id_eva = ?")) {
